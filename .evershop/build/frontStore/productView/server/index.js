...
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(67294);
;// CONCATENATED MODULE: ./packages/evershop/src/components/common/CKEditor.jsx
...
;// CONCATENATED MODULE: ./packages/evershop/src/modules/catalog/pages/frontStore/productView/Description.jsx
/* eslint-disable react/no-danger */
...
// EXTERNAL MODULE: ./packages/evershop/src/lib/util/events.js
var events = __webpack_require__(75038);
...
function Form(props) {
  ...
  var submit = async e => {
    ...
    setState('submitting');
    try {
      pubsub_default().publishSync(events/* FORM_SUBMIT */.Oh, {
        props
      });
      var errors = validate();
      pubsub_default().publishSync(events/* FORM_VALIDATED */.C2, {
        formId: id,
        errors
      });
      if (Object.keys(errors).length === 0) {
...
// EXTERNAL MODULE: ./packages/evershop/src/components/common/form/fields/Input.jsx
var Input = __webpack_require__(86010);
// EXTERNAL MODULE: ./packages/evershop/src/components/common/form/fields/MultiSelect.jsx
var MultiSelect = __webpack_require__(66109);
...
// EXTERNAL MODULE: ./packages/evershop/src/components/common/form/fields/Select.jsx
var Select = __webpack_require__(87312);
...
function Field(props) {
  ...
  react.useEffect(() => {
    pubsub_default().publishSync(events/* FORM_FIELD_UPDATED */.S, {
      name,
      value: fieldValue
    });
  }, [fieldValue]);
  ...
  var F = (() => {
    switch (type) {
      ...
      case 'multiselect':
        return MultiSelect/* MultiSelect */.N;
      case 'checkbox':
        return Checkbox;
      case 'radio':
        return Radio;
...
// EXTERNAL MODULE: ./packages/evershop/src/lib/locale/translate/index.js
var translate = __webpack_require__(34589);
// EXTERNAL MODULE: ./packages/evershop/src/components/common/ProductNoThumbnail.jsx
var ProductNoThumbnail = __webpack_require__(34029);
;// CONCATENATED MODULE: ./packages/evershop/src/modules/catalog/pages/frontStore/productView/Form.jsx
...
function ToastMessage(_ref) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    onClick: e => {
      e.preventDefault();
      react_toastify_esm/* toast.dismiss */.Am.dismiss(toastId);
    }
  }, /*#__PURE__*/react.createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    className: "h-6 w-6",
    ...
    src: thumbnail,
    alt: name
  }) : /*#__PURE__*/react.createElement(ProductNoThumbnail/* default */.Z, {
    width: 25,
    height: 25
  })), /*#__PURE__*/react.createElement("div", {
...
function AddToCart(_ref2) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "mt-1"
  }, stockAvaibility === true && /*#__PURE__*/react.createElement(Button/* default */.Z, {
  ...
  }), stockAvaibility === false && /*#__PURE__*/react.createElement(Button/* default */.Z, {
...
function ProductForm(_ref3) {
  ...
  var appContext = (0,app/* useAppState */.mr)();
  var {
    setData
  } = (0,app/* useAppDispatch */.TL)();
  var onSuccess = response => {
    if (!response.error) {
      setData((0,immer_esm/* default */.ZP)(appContext, draff => {
        draff.cart = appContext.cart || {};
        draff.cart.totalQty = response.data.count;
        draff.cart.uuid = response.data.cartId;
      }));
      setToastId((0,react_toastify_esm/* toast */.Am)( /*#__PURE__*/react.createElement(ToastMessage, {
...
// EXTERNAL MODULE: ./packages/evershop/src/components/common/Area.jsx
var Area = __webpack_require__(96837);
;// CONCATENATED MODULE: ./packages/evershop/src/components/frontStore/catalog/product/single/Name.jsx
...
;// CONCATENATED MODULE: ./packages/evershop/src/components/frontStore/catalog/product/single/Price.jsx
...
;// CONCATENATED MODULE: ./packages/evershop/src/components/frontStore/catalog/product/single/Sku.jsx
...
;// CONCATENATED MODULE: ./packages/evershop/src/modules/catalog/pages/frontStore/productView/GeneralInfo.jsx
...
/* harmony export */   "query": () => (/* binding */ query)
/* harmony export */ });
/* harmony import */ var _components_common_ProductNoThumbnail__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(34029);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(45697);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_2__);
...
function Current(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
    ...
    alt: image.alt,
    className: "self-center"
  }), !image && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_common_ProductNoThumbnail__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z, {
    width: 250,
    height: 250
  }));
}
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
/* harmony import */ var _components_common_form_fields_MultiSelect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(66109);
/* harmony import */ var _components_common_form_fields_Select__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(87312);
/* eslint-disable react/no-array-index-key */
...
function Options(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    ...
    switch (o.optionType) {
      case 'select':
        FieldComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_common_form_fields_Select__WEBPACK_IMPORTED_MODULE_2__/* .Select */ .P, {
          key: i,
        ...
        break;
      case 'multiselect':
        FieldComponent = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_common_form_fields_MultiSelect__WEBPACK_IMPORTED_MODULE_1__/* .MultiSelect */ .N, {
          key: i,
          name: "product_custom_options[".concat(o.optionId, "][]"),
          options: values,
          validation_rules: parseInt(o.isRequired, 10) === 1 ? ['notEmpty'] : [],
...
/* harmony import */ var _evershop_evershop_src_lib_util_events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(75038);
/* harmony import */ var _components_common_context_app__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(56632);
/* harmony import */ var _evershop_evershop_src_lib_locale_translate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(34589);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
...
function Variants(_ref2) {
  ...
  react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
    var token = pubsub_js__WEBPACK_IMPORTED_MODULE_1___default().subscribe(_evershop_evershop_src_lib_util_events__WEBPACK_IMPORTED_MODULE_4__/* .FORM_VALIDATED */ .C2, (message, data) => {
...
_evershop_evershop_src_components_common_Area__WEBPACK_IMPORTED_MODULE_2__/* ["default"].defaultProps.components */ .Z.defaultProps.components = {
  ...
  productViewGeneralInfo: {
    'XHBhY2thZ2VzXGV2ZXJzaG9wXHNyY1xtb2R1bGVzXGNhdGFsb2dccGFnZXNcZnJvbnRTdG9yZVxwcm9kdWN0Vmlld1xBdHRyaWJ1dGVzLmpzeA==': {
      ...
      sortOrder: 25,
      component: __webpack_require__(52150)
    }
  },
  productPageMiddleRight: {
    'XHBhY2thZ2VzXGV2ZXJzaG9wXHNyY1xtb2R1bGVzXGNhdGFsb2dccGFnZXNcZnJvbnRTdG9yZVxwcm9kdWN0Vmlld1xEZXNjcmlwdGlvbi5qc3g=': {
      ...
      sortOrder: 50,
      component: __webpack_require__(3862)
    },
    'XHBhY2thZ2VzXGV2ZXJzaG9wXHNyY1xtb2R1bGVzXGNhdGFsb2dccGFnZXNcZnJvbnRTdG9yZVxwcm9kdWN0Vmlld1xGb3JtLmpzeA==': {
      ...
      sortOrder: 20,
      component: __webpack_require__(2028)
    },
    'XHBhY2thZ2VzXGV2ZXJzaG9wXHNyY1xtb2R1bGVzXGNhdGFsb2dccGFnZXNcZnJvbnRTdG9yZVxwcm9kdWN0Vmlld1xHZW5lcmFsSW5mby5qc3g=': {
      ...
      sortOrder: 10,
      component: __webpack_require__(42037)
    },
    'XHBhY2thZ2VzXGV2ZXJzaG9wXHNyY1xtb2R1bGVzXGNhdGFsb2dccGFnZXNcZnJvbnRTdG9yZVxwcm9kdWN0Vmlld1xPcHRpb25zLmpzeA==': {
      ...
      sortOrder: 30,
      component: __webpack_require__(88089)
    },
    'XHBhY2thZ2VzXGV2ZXJzaG9wXHNyY1xtb2R1bGVzXGNhdGFsb2dccGFnZXNcZnJvbnRTdG9yZVxwcm9kdWN0Vmlld1xWYXJpYW50cy5qc3g=': {
      ...
      sortOrder: 40,
      component: __webpack_require__(2044)
    }
  },
  productPageMiddleLeft: {
    XHBhY2thZ2VzXGV2ZXJzaG9wXHNyY1xtb2R1bGVzXGNhdGFsb2dccGFnZXNcZnJvbnRTdG9yZVxwcm9kdWN0Vmlld1xJbWFnZXMuanN4: {
      ...
      sortOrder: 10,
      component: __webpack_require__(66810)
    }
  },
  content: {
    XHBhY2thZ2VzXGV2ZXJzaG9wXHNyY1xtb2R1bGVzXGNhdGFsb2dccGFnZXNcZnJvbnRTdG9yZVxwcm9kdWN0Vmlld1xMYXlvdXQuanN4: {
      ...
      sortOrder: 10,
      component: __webpack_require__(12973)
    },
